...
def cambiar_pin():
    ...
    while True:
        try:
            ...
            pin_actual=int(input("ingrese su pin"))
        
            if pin==pin_actual:
                nuevo_pin=int(input("ingrese nuevo pin"))
                pin=nuevo_pin
                print("haz cambiado de pin")
                break   
            else:
                print("clave incorrecta, ingrese de nuevo")
        except ValueError:
            print("no puede dejar el campo asi")            
